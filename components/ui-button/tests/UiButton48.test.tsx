...
describe('UiButton48', () => {
  ...
  describe('link', () => {
    it('renders link when `as` is `link`', () => {
      render(
        <UiButton48 as="a" href="#" testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows render an icon', () => {
      render(
        <UiButton48 as="a" href="#" icon={Icon} testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to provide className', () => {
      ...
      render(
        <UiButton48 as="a" className={className} href="#" testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to provide title', () => {
      ...
      render(
        <UiButton48 as="a" href="#" testId="subject" title={title} variant={variant}>
          {label}
        </UiButton48>,
      );
    ...
    it('allows to provide track id', () => {
      ...
      render(
        <UiButton48 as="a" href="#" testId="subject" trackId={trackId} variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to disable button', () => {
      render(
        <UiButton48 as="a" href="#" isDisabled testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to freeze button', () => {
      render(
        <UiButton48 as="a" href="#" isFrozen testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('has different classes for disabled and frozen states', () => {
      render(
        <>
          <UiButton48 as="a" href="#" testId="enabled-subject" variant={variant}>
            Button
          </UiButton48>
          <UiButton48 as="a" href="#" isDisabled testId="disabled-subject" variant={variant}>
            Button
          </UiButton48>
          <UiButton48 as="a" href="#" isFrozen testId="frozen-subject" variant={variant}>
            Button
          </UiButton48>
        </>,
      );
    ...
    it('renders href attribute', () => {
      ...
      render(
        <UiButton48 as="a" href={href} testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to provide target', () => {
      render(
        <UiButton48 as="a" href="#" target="_blank" testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to provide rel', () => {
      render(
        <UiButton48 as="a" href="#" rel="noreferrer noopener" testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
  ...
  describe('visual', () => {
    it('renders div when `as` is `visual`', () => {
      render(
        <UiButton48 as="div" testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows render an icon', () => {
      render(
        <UiButton48 as="div" icon={Icon} testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to provide className', () => {
      ...
      render(
        <UiButton48 as="div" className={className} testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to provide title', () => {
      ...
      render(
        <UiButton48 as="div" testId="subject" title={title} variant={variant}>
          {label}
        </UiButton48>,
      );
    ...
    it('allows to provide track id', () => {
      ...
      render(
        <UiButton48 as="div" testId="subject" trackId={trackId} variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to disable button', () => {
      render(
        <UiButton48 as="div" isDisabled testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('allows to freeze button', () => {
      render(
        <UiButton48 as="div" isFrozen testId="subject" variant={variant}>
          Button
        </UiButton48>,
      );
    ...
    it('has different classes for disabled and frozen states', () => {
      render(
        <>
          <UiButton48 as="div" testId="enabled-subject" variant={variant}>
            Button
          </UiButton48>
          <UiButton48 as="div" isDisabled testId="disabled-subject" variant={variant}>
            Button
          </UiButton48>
          <UiButton48 as="div" isFrozen testId="frozen-subject" variant={variant}>
            Button
          </UiButton48>
        </>,
      );
