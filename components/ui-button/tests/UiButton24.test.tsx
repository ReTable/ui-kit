...
describe('UiButton24', () => {
  ...
  describe('button', () => {
    ...
    it('allows to provide track id', () => {
      ...
      render(
        <UiButton24 data-testid="subject" trackId={trackId} type="button" variant={variant}>
          Button
        </UiButton24>,
      );
  ...
  describe('a', () => {
    ...
    it('allows to provide track id', () => {
      ...
      render(
        <UiButton24 as="a" href="#" data-testid="subject" trackId={trackId} variant={variant}>
          Button
        </UiButton24>,
      );
  ...
  describe('div', () => {
    ...
    it('allows to provide track id', () => {
      ...
      render(
        <UiButton24 as="div" data-testid="subject" trackId={trackId} variant={variant}>
          Button
        </UiButton24>,
      );
